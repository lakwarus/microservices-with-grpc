...
func local_request_StockService_UpdateStock_0(ctx context.Context, marshaler runtime.Marshaler, server StockServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateStockRequest
	var metadata runtime.ServerMetadata
...
func RegisterStockServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StockServiceServer) error {
	...
	mux.Handle("PUT", pattern_StockService_UpdateStock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_StockService_UpdateStock_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_StockService_UpdateStock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "stock"}, "", runtime.AssumeColonVerbOpt(true)))
)
